                    ...
                    <div class="ibox ">
                        <div class="ibox-content">
                            ...
                            <div class="bar operate-bar">
                                <button class="control-auth btn btn-sm btn-primary" data-auth="menu_create" onclick="Menu.create()">新增</button>
                            </div>
                ...
                <form class="form-horizontal" id="create-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-block m-b-none">注：如果是顶层菜单就不选；如果又是一级菜单，url填#</span>

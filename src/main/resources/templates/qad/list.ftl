                        ...
                        <div class="ibox-content">
                            <div class="bar search-bar">
                                <div class="form-inline">
                                    ...
                                    <button class="btn btn-success"  id="search" type="button" onclick="Qad.search()">搜索</button>
                                    <button class="btn btn-success" type="button" onclick="Qad.resetSearch()">重置</button>
...
<script src="/static/modular/qad/qad.js"></script>

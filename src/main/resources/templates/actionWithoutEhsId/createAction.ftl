        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="/actionWithoutEhsId/seeAction">Action表</a>
                    </li>
                    <li class="active">
                        <strong>创建行动</strong>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-10 col-sm-offset-2">
                        ...
                        <br>
                        <div class="">
                            <button type="button" class="btn btn-sm btn-primary ladda-button" data-style="slide-left" onclick="ActionWithoutEhsId.insert(this)">确  定</button>
